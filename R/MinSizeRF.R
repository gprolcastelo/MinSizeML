#' Random forest algorithm for minimum sample size estimation
#' 
#' This algorithm determines the minimum sample size to use with the algorithm
#' random forest, given a minimum value for the metric ("Accuracy" or "Kappa")
...
#' @param metric Metric to use to determine minimum sample size.
#' Use "Accuracy" or "Kappa" for classification.
...
#' @export
MinSizeRF <- function(X,Y,metric,thr_metric,p_vec=1:99/100,n.cores=1){
